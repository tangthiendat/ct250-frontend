    ...
    <div className="relative top-6 flex min-h-full flex-col justify-center">
          ...
          {bannerImages.map((banner) => (
            <div key={banner.alt}>
              <img
                src={banner.src}
                alt={banner.alt}
                className="mx-auto w-[98%] rounded-xl px-10 md:w-[80%]"
              />
            </div>
          ))}
        </Carousel>
      ...
      <div className="py-10">
        ...
        <Carousel
          ...
          pauseOnHover={false}
          slidesToShow={3}
          className="bg-re-700 mx-auto w-[90%] pt-2 lg:w-[80%]"
          responsive={[
            {
              breakpoint: 1024,
              settings: {
        ...
        >
          {moreServices.map((service) => (
            <div key={service.alt} className="bg-red700 pb-8">
              <div className="mx-auto h-[380px] w-[90%] cursor-pointer rounded-xl bg-white shadow-xl sm:h-[430px] md:h-[380px] lg:h-[430px] xl:h-[380px]">
