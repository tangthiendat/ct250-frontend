...
const Footer: React.FC = () => {
  return (
    <div>
      <footer className="flex flex-col items-center rounded-3xl border-t border-gray-200 bg-white px-6 py-4 shadow-[0px_-15px_25px_-15px_rgba(0,0,0,0.3)] md:flex-row">
